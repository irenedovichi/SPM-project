...
inline float hsum_sse3(__m128 v) {
    ...
    shuf        = _mm_movehl_ps(shuf, maxs); // moves the upper two SP FP values of shuf to the lower two SP FP values of the result. The upper two SP FP values of maxs are passed through to the result.
